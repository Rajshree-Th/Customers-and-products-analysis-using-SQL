...
/*to use database myproject*/
USE myproject;

/*dropping any table named customers if there exist*/
...
/*to insert values to the table customers*/
...
/*dropping if there exist any table named employees*/
...
/*dropping if there exist any table named offices*/
...
/*inserting values to the offices table*/
...
/*deleting any table named orderdetails if there exist*/
...
/*inserting values to the table orderdetails*/
...
#deleting any table named orders if there exist*/
...
/*deleting any table named payments if the exists*/
...
/*inserting values to table payments*/
...
/*deleting any table named productionlines if there exist*/
...
/*inserting values to table productlines*/
